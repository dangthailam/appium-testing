...
describe("Vendeur - Gérer son produit", function () {
    ...
    it("Ajouter une nouvelle photo", function (done) {
        ...
        .should.eventually.exist
        .click()
        .elementByAccessibilityId("Add picture")
        .should.eventually.exist
        .click()
        .elementByAccessibilityId("My items for sale")
        .should.eventually.exist
        ...
        .should.eventually.exist
        .click()
        .elementByAccessibilityId("Camera Roll")
        .should.eventually.exist
        .click()
        ...
        .should.eventually.exist
        .click()
        .elementByAccessibilityId("bar_notif_confirm")
        .should.eventually.exist
        .nodeify(done);
    });
    ...
    it("Baisse de prix", function (done) {
        _shared.login.shouldLogin(driver)
            ...
            .should.eventually.exist
            .click()
            .waitForElementByAccessibilityId("I no longer wish to sell it")
            .should.eventually.exist

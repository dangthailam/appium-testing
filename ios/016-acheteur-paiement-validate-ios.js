...
describe("Paiement", function () {
    ...
    it("Paiment / Valider le paiement", function (done) {
        ...
        //_shared.methods.shouldLogin(driver, 'ngoc.le+4@vestiairecollective.com', '002299')
            ...
            // })
            // .then(function (value) {
            //     var productPrice1 = parseFloat(value.substring(0, value.length - 2));
            ...
            // })
            // .then(function (value) {
            //     var productPrice2 = parseFloat(value.substring(0, value.length - 2)); // Tai sao van may 500 € ma ko phai la 500
